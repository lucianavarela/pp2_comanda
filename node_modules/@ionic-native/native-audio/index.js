...
var NativeAudio = (function (_super) {
    ...
    /**
       ...
       * @returns {Promise<any>}
       */
    NativeAudio.prototype.preloadSimple = /**
       * Loads an audio file into memory. Optimized for short clips / single shots (up to five seconds). Cannot be stopped / looped.
       * @param id {string} unique ID for the audio file
       * @param assetPath {string}  the relative path or absolute URL (inluding http://) to the audio asset.
       * @returns {Promise<any>}
       */
    function (id, assetPath) { return; };
    /**
    ...
    /**
       ...
       * @returns {Promise<any>}
       */
    NativeAudio.prototype.preloadComplex = /**
       * Loads an audio file into memory. Optimized for background music / ambient sound. Uses highlevel native APIs with a larger footprint. (iOS: AVAudioPlayer). Can be stopped / looped and used with multiple voices. Can be faded in and out using the delay parameter.
       * @param id {string} unique ID for the audio file
       * @param assetPath {string}  the relative path or absolute URL (inluding http://) to the audio asset.
       * @param volume {number} the volume of the preloaded sound (0.1 to 1.0)
       ...
       * @returns {Promise<any>}
       */
    function (id, assetPath, volume, voices, delay) { return; };
    /**
    ...
    /**
       ...
       * @returns {Promise<any>}
       */
    NativeAudio.prototype.play = /**
       * Plays an audio asset
       * @param id {string} unique ID for the audio file
       * @param completeCallback {Function} optional. Callback to be invoked when audio is done playing
       * @returns {Promise<any>}
       */
    function (id, completeCallback) { return; };
    /**
    ...
    /**
       ...
       * @returns {Promise<any>}
       */
    NativeAudio.prototype.setVolumeForComplexAsset = /**
       * Changes the volume for preloaded complex assets.
       * @param id {string} unique ID for the audio file
       * @param volume {number} the volume of the audio asset (0.1 to 1.0)
       * @returns {Promise<any>}
       */
    function (id, volume) { return; };
